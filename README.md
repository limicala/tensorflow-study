...
3. Other([Notebook](http://nbviewer.jupyter.org/github/Hvass-Labs/TensorFlow-Tutorials/tree/master/) [中文版](http://nbviewer.jupyter.org/github/thrillerist/TensorFlow-Tutorials/tree/master/))
...
3. [PrettyTensor](http://nbviewer.jupyter.org/github/limicala/tensorflow-study/blob/master/03.PrettyTensor.ipynb)

4. [Save_And_Store](http://nbviewer.jupyter.org/github/limicala/tensorflow-study/blob/master/04.Save_And_Restore.ipynb)

5. [Ensemble_Learning](http://nbviewer.jupyter.org/github/limicala/tensorflow-study/blob/master/05.Ensemble_Learning.ipynb)